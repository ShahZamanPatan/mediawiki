...
$magicWords = [
	...
	'currentdayname'            => [ '1', 'نننۍورځې_نوم', 'CURRENTDAYNAME' ],
	'currentdow'                => [ '1', 'د‌اوونۍ‌نن‌ورځ', 'CURRENTDOW' ],
	'currenthour'               => [ '1', 'دم_گړۍ', 'CURRENTHOUR' ],
	...
	'grammar'                   => [ '0', 'گرامر:', 'GRAMMAR:' ],
	'hiddencat'                 => [ '1', '__پټه_وېشنيزه__', '__HIDDENCAT__' ],
	'img_center'                => [ '1', 'منځ،_center', 'center', 'centre' ],
	'img_left'                  => [ '1', 'کيڼ', 'left' ],
	'img_none'                  => [ '1', 'هېڅ', 'none' ],
	...
	'localday'                  => [ '1', 'سيمه_ييزه_ورځ', 'LOCALDAY' ],
	'localday2'                 => [ '1', 'سيمه_ييزه_ورځ۲', 'LOCALDAY2' ],
	'localdayname'              => [ '1', 'دسيمه_ييزې_ورځ_نوم', 'LOCALDAYNAME' ],
	'localhour'                 => [ '1', 'سيمه_ييزه_گړۍ', 'LOCALHOUR' ],
	'localmonth'                => [ '1', 'سيمه_ييزه_مياشت', 'LOCALMONTH', 'LOCALMONTH2' ],
	'localmonthabbrev'          => [ '1', 'دسيمه_ييزې_مياشت_لنډون', 'LOCALMONTHABBREV' ],
	'localmonthname'            => [ '1', 'دسيمه_ييزې_مياشت_نوم', 'LOCALMONTHNAME' ],
	'localtime'                 => [ '1', 'سيمه_ييزوخت', 'LOCALTIME' ],
	'localweek'                 => [ '1', 'سيمه_ييزه_اوونۍ', 'LOCALWEEK' ],
	'localyear'                 => [ '1', 'سيمه_ييزکال', 'LOCALYEAR' ],
	'msg'                       => [ '0', 'پیغام:', 'پ:', 'MSG:' ],
	'namespace'                 => [ '1', 'نوم_تشيال', 'NAMESPACE' ],
	'namespacee'                => [ '1', 'د_نوم_تشيال_نښه', 'NAMESPACEE' ],
	'noeditsection'             => [ '0', '__بی‌برخې__', '__NOEDITSECTION__' ],
	'nogallery'                 => [ '0', '__بی‌انځورتونه__', '__NOGALLERY__' ],
	...
	'numberofusers'             => [ '1', 'دکارنانو‌شمېر', 'NUMBEROFUSERS' ],
	...
	'redirect'                  => [ '0', '#مخگرځ', '#REDIRECT' ],
	'server'                    => [ '0', 'پالنگر', 'SERVER' ],
	'servername'                => [ '0', 'دپالنگر_نوم', 'SERVERNAME' ],
	'sitename'                  => [ '1', 'دوېبځي_نوم', 'SITENAME' ],
	'special'                   => [ '0', 'ځانگړی', 'special' ],
