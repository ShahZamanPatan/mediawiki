...
$specialPageAliases = [
	...
	'Blankpage'                 => [ 'تش_مخ' ],
	'Block'                     => [ 'بنديز،_د_آی_پي_بنديز،_بنديز_لگېدلی_کارن_Block' ],
...
#   ID                               CASE  SYNONYMS
	...
	'articlepath'             => [ 0, 'ليکنې‌لوری' ],'ARTICLEPATH' ],
	...
	'formatdate'              => [ 0, 'نېټه_بنل' ,'نېټې_بڼه' ,'نېټه‌بڼل' ,'نېټې‌بڼه' ,'formatdate', 'dateformat' ],
	...
	'server'                  => [ 0, 'ښوونګر','ښوونگر','پالنګر','پالنگر','SERVER' ],
	...
	'subpagename'             => [ 1, 'څېرمه‌مخ‌نوم' ,'SUBPAGENAME' ],
